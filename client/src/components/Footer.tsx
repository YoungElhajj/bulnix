...
export default function Footer() {
  return (
    <footer className="border-t border-[#0F3D5E]/50 bg-[#040f1a]">
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="w-9 h-9 rounded-lg bg-[#0F3D5E]/40 border border-[#0F3D5E] flex items-center justify-center text-slate-400 hover:text-[#00C2FF] hover:border-[#00C2FF]/40 transition-colors" title="Twitter/X">
                <Twitter className="h-4 w-4" />
              </a>
              <a href={TELEGRAM_URL} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-[#0F3D5E]/40 border border-[#0F3D5E] flex items-center justify-center text-slate-400 hover:text-[#00C2FF] hover:border-[#00C2FF]/40 transition-colors" title="Telegram Channel">
                <Send className="h-4 w-4" />
              </a>
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-[#0F3D5E]/40 border border-[#0F3D5E] flex items-center justify-center text-slate-400 hover:text-[#25D366] hover:border-[#25D366]/40 transition-colors" title="WhatsApp Support">
              ...
              <a href="mailto:support@bulnix.com" className="w-9 h-9 rounded-lg bg-[#0F3D5E]/40 border border-[#0F3D5E] flex items-center justify-center text-slate-400 hover:text-[#00C2FF] hover:border-[#00C2FF]/40 transition-colors" title="Email Support">
        ...
        {/* Trust Badges */}
        <div className="mt-12 pt-8 border-t border-[#0F3D5E]/50">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center">
              {["Paystack", "Monnify", "Crypto"].map(method => (
                <span key={method} className="px-3 py-1 rounded-md bg-[#0F3D5E]/40 border border-[#0F3D5E] text-slate-400 text-xs font-medium">
                  {method}
                </span>
              ))}
            </div>
