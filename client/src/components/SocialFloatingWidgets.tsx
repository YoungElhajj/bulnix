 ...
 * Floating action buttons for WhatsApp live support and Telegram channel.
 * Update TELEGRAM_URL and WHATSAPP_URL to your real links.
 */
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {open && (
        <div className="flex flex-col items-end gap-3 animate-in slide-in-from-bottom-4 fade-in duration-200">
          ...
          >
            <span className="bg-background border border-border text-foreground text-sm font-medium px-3 py-1.5 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
              Live Support
            </span>
            <div className="w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110 active:scale-95"
