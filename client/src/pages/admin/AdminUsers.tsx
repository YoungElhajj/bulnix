        ...
        {isLoading ? (
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              {d.orders.length === 0 ? (
                <div className="text-xs text-slate-500 py-3">No orders yet.</div>
              ) : (
                <div className="space-y-2">
                  {d.orders.map((order: any) => (
                    <div key={order.id} className="glass-card rounded-lg p-3 flex items-center gap-3">
                      <div className="flex-1 min-w-0">
            ...
            <div>
              ...
              {d.walletTransactions.length === 0 ? (
                <div className="text-xs text-slate-500 py-3">No transactions yet.</div>
              ) : (
                <div className="space-y-2">
            ...
            <div>
              ...
              {d.tickets.length === 0 ? (
                <div className="text-xs text-slate-500 py-3">No tickets yet.</div>
              ) : (
                <div className="space-y-2">
                  {d.tickets.map((ticket: any) => (
                    <div key={ticket.id} className="glass-card rounded-lg p-3 flex items-center gap-3">
                      <div className="flex-1 min-w-0">
    ...
    <AdminLayout title="Users">
      ...
      {isLoading ? (
        ...
        <div className="glass-card rounded-xl p-12 text-center">
          ...
          <p className="text-slate-500 text-sm">Users will appear here once they sign up.</p>
        </div>
      ) : (
