                  ...
                  <tr key={ticket.id} className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                    <td className="p-4">
                      ...
                      <div className="text-xs text-slate-500">
                        ...
                        {ticket.orderId && <span className="ml-2 text-slate-600">Order #{ticket.orderId}</span>}
                      </div>
                    </td>
            ...
            <div className="space-y-4 mt-2">
              ...
              <div className="p-3 bg-orange-500/5 border border-orange-500/20 rounded-lg">
                ...
                <div className="flex gap-3 mt-1">
                  <span className="text-slate-500 text-xs">Ticket #{selected.ticketNumber ?? selected.id}</span>
                  {selected.orderId && <span className="text-slate-500 text-xs">Order #{selected.orderId}</span>}
                  <span className="text-slate-500 text-xs">User #{selected.userId}</span>
                </div>
              </div>
              ...
              {createdClaimId ? (
                ...
                <>
                  ...
                  <div>
                    <Label className="text-slate-400 text-xs mb-1.5 block">Supplier Order ID <span className="text-slate-600">(from AccsZone dashboard)</span></Label>
                    <Input
                  ...
                  <div>
                    <Label className="text-slate-400 text-xs mb-1.5 block">Internal Admin Notes <span className="text-slate-600">(not sent to supplier)</span></Label>
                    <Textarea
          ...
          {claimSubmitted && submittedMessage && (
            <div className="space-y-4 mt-2">
              ...
              <div className="bg-[#0B0F19] rounded-lg p-4 border border-white/5">
                ...
                <pre className="text-slate-300 text-xs whitespace-pre-wrap leading-relaxed font-mono">{submittedMessage}</pre>
              </div>
              <div className="flex gap-2">
                <Button
                  variant="outline"
