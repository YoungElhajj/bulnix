...
export default function Privacy() {
  return (
    <div className="min-h-screen bg-[#F5F9FF] text-[#0D2137]">
      <SEO title="Privacy Policy | Bulnix" description="Read the Bulnix Privacy Policy. Learn how we collect, use, and protect your personal data when you use our digital accounts marketplace." canonical="https://bulnix.com/privacy" />
      <Navbar/>
